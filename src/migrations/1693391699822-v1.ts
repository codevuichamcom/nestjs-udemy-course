...
export class v11693391699822 implements MigrationInterface {
    name = 'v11693391699822'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users_follower_user_users" ("usersId_1" integer NOT NULL, "usersId_2" integer NOT NULL, CONSTRAINT "PK_f3a569255140d2fbff9494d46b1" PRIMARY KEY ("usersId_1", "usersId_2"))`);
        await queryRunner.query(`CREATE INDEX "IDX_632b77c8955e64a8cf2204b765" ON "users_follower_user_users" ("usersId_1") `);
        await queryRunner.query(`CREATE INDEX "IDX_ca3b9f2f4ee6cae1612c9c351e" ON "users_follower_user_users" ("usersId_2") `);
        ...
        await queryRunner.query(`ALTER TABLE "users_follower_user_users" ADD CONSTRAINT "FK_632b77c8955e64a8cf2204b7651" FOREIGN KEY ("usersId_1") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "users_follower_user_users" ADD CONSTRAINT "FK_ca3b9f2f4ee6cae1612c9c351e0" FOREIGN KEY ("usersId_2") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "users_follower_user_users" DROP CONSTRAINT "FK_ca3b9f2f4ee6cae1612c9c351e0"`);
        await queryRunner.query(`ALTER TABLE "users_follower_user_users" DROP CONSTRAINT "FK_632b77c8955e64a8cf2204b7651"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_ca3b9f2f4ee6cae1612c9c351e"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_632b77c8955e64a8cf2204b765"`);
        await queryRunner.query(`DROP TABLE "users_follower_user_users"`);
